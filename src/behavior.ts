...
const spinnerLoader = document.querySelector("div.spin-loader") as HTMLElement;
//
const loginToVerify = document.querySelector("div.login-to-verify-age") as HTMLElement;
const loginButton = loginToVerify.querySelector("button") as HTMLButtonElement;
//
const articlesContainer = document.querySelector("div.articles") as HTMLElement;
//
const openLogin = document.querySelector("div.open-app") as HTMLElement;
...
let relatedSuggestions: relatedVideo[] = [
    { 
